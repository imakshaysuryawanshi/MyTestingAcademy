...
doc.add_paragraph('2. Enter a valid registered Email ID in the input field.', style='List Number')
doc.add_paragraph('3. Enter the correct Password associated with the account.', style='List Number')
...
print(f"Bug report successfully updated: {output_path}")
