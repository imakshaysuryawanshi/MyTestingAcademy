...
const normalizeTC = (tc, idx) => {
  ...
  const desc        = getVal(tc, ["Description","description","Title","title","summary","scenario"]) || "—";
  ...
  return { id, cat, desc, pre, stepsArr, expected, Test_Data: data, prio, status, _raw: tc };
};
...
export default function TestCases() {
  ...
  const handleExportXLSX = () => {
    ...
    // Column widths
    ws["!cols"] = [{ wch: 10 }, { wch: 14 }, { wch: 40 }, { wch: 30 }, { wch: 50 },
